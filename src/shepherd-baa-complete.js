 ...
 * 阶段 4：结束 → 羊重复用户指令
 * 
 * 用法：node shepherd-baa-complete.js [用户指令] [sessionKey]
 */
...
function sendMessage(text) {
    console.log(text);
    console.log('---PHASE_SEPARATOR---');
}

/**
 * 阶段 1：立即回复
 */
function phase1(userCommand) {
